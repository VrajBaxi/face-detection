package com.machinelearning.perfect.facedetection
...
import com.machinelearning.perfect.facedetection.Helper.RectOverlay
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Init
        waitingDialog = AlertDialog.Builder(this).setMessage("Please wait...").setCancelable(false).create()
